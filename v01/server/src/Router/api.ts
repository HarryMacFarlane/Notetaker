...
import { authenticateUser, userController, groupController, docController } from '../Controllers/index.js';
...
apiRouter.use(authenticateUser as RequestHandler); // Authenticate user before allowing access to the API
